...
var Board = React.createClass({
  render: function(){
    var board = [];
      for(var i = 0; i < 3; i++){
      board.push(<List  title={this.props.lists[i].title} 
                        cards={this.props.lists[i].cards}
                        onAddInputChanged={this.props.lists[i].onAddInputChanged}
                        onAddSubmit={this.props.lists[i].onAddSubmit}
                 />);
    }
    return(
      <div className="board">
